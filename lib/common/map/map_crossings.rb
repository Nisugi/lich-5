  ...
  module Common
    module MapEngine
      module UniqueCrossings
        ...
        define('crossing_7_3668') do # 7:3668
        ...
        define('crossing_339_24768') do # 339:24768
        ...
        define('crossing_6274_11032') do # 6274:11032
        ...
        define('crossing_11032_6274') do # 11032:6274
          force_go2 = proc { |room_num| go2_count = Script.running.find_all { |s| s.name == 'go2' }.length
          force_start_script 'go2', [ room_num.to_s ]
          wait_while { Script.running.find_all { |s| s.name == 'go2' }.length > go2_count } }
          script = Script.self
        ...
        define('crossing_14726_18172') do # 14726:18172
        ...
        define('crossing_18181_18182') do # 18181:18182
        ...
        define('crossing_18677_11749') do # 18677:11749
        ...
        define('crossing_24238_21557') do # 24238:21557
          fput "get pile";fput "push raft";fput "go raft";echo "Waiting possibly up to 5 minutes or more for the geyser to shoot...";line = get until Room.current.id != 24238
        end

        define('crossing_24239_24240') do # 24239:24240

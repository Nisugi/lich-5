{
  ...
  noun: nil,                     # in-game noun (optional; leave nil if same as name)
  url: nil,
  picture: nil,

  level: nil, # Integer
  family: nil,                   # e.g., "canine", "gigas"
  type: nil,                     # e.g., "biped", "quadruped", "avian", "ooze"
  ...
  size: nil, # "small" | "medium" | "large" | "huge" | ...

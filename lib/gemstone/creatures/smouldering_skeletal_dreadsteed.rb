{
  ...
  messaging: {
    ...
    flee: [],
    death: [
      "Beautiful shot pierces both lungs, the skeletal dreadsteed makes a wheezing noise, and drops dead!",
      "Awesome shot skewers skull!  The skeletal dreadsteed blinks once and falls quite dead!"
    ],
    decay: [],
    search: [],
    spell_prep: [],
